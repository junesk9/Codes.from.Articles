...
1. ***[search.prom_motif.220528.py](https://github.com/junesk9/In-house.codes.published/blob/main/search.prom_motif.220528.py)*** - Python3 script to search & count the given cis-elements in the 1-kb Brachypodium promoter regions.
