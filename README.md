...
***
### "Arabidopsis fugu5 cotyledon scRNA-seq"
Tabeta et al. 
...
2. ***[At-tabeta.vol1.Rmd](https://github.com/junesk9/Codes.from.Articles/blob/main/2026.Tabeta1/At-tabeta.vol1.Rmd)*** - R markdown script for COPILOT-Seurat analysis of the cotyledon snRNA-seq data, part 1a.
3. ***[At-tabeta.vol2.Rmd](https://github.com/junesk9/Codes.from.Articles/blob/main/2026.Tabeta1/At-tabeta.vol2.Rmd)*** - R markdown script for COPILOT-Seurat analysis of the cotyledon snRNA-seq data, part 1b.
4. ***[At-tabeta.vol3.Rmd](https://github.com/junesk9/Codes.from.Articles/blob/main/2026.Tabeta1/At-tabeta.vol3.Rmd)*** - R markdown script for COPILOT-Seurat analysis of the cotyledon snRNA-seq data, part 1c.
5. ***[At-tabeta.vol4.Rmd](https://github.com/junesk9/Codes.from.Articles/blob/main/2026.Tabeta1/At-tabeta.vol4.Rmd)*** - R markdown script for COPILOT-Seurat analysis of the cotyledon snRNA-seq data, part 1d.
6. ***[At.copilot.v2.2412.R](https://github.com/junesk9/Codes.from.Articles/blob/main/2026.Tabeta1/At.copilot.v2.2412.R)*** - R script for COPILOT-Seurat analysis of the cotyledon snRNA-seq data, part 2.
7. ***[At.copilot.v3.2511.R](https://github.com/junesk9/Codes.from.Articles/blob/main/2026.Tabeta1/At.copilot.v3.2511.R)*** - R script for COPILOT-Seurat analysis of the cotyledon snRNA-seq data, part 3.
8. ***[At.copilot.v4.2601.R](https://github.com/junesk9/Codes.from.Articles/blob/main/2026.Tabeta1/At.copilot.v4.2601.R)*** - R script for COPILOT-Seurat analysis of the cotyledon snRNA-seq data, part 4.  
