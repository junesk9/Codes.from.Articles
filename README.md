...
6. 6. ***[6_count.NC-motif.py](https://github.com/junesk9/Codes.from.Articles/blob/main/NCIntron.2025/6_count.NC-motif.py)*** - Python3 script to count the introns by known intron patterns.  
